...
{
    public class AssemblyConfigurationMapBuilder
    {
        public AssemblyConfigurationMapBuilder()
        {
        }
        ...
        public AssemblyConfigurationMap BuildFor(Assembly assembly)
        {
            var map = new AssemblyConfigurationMap();
        ...
        private void FixMissingConfigurationsFor(AssemblyConfigurationMap configurationMap, Assembly assembly)
        {
