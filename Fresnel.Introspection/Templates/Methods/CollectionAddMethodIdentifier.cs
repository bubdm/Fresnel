...
{
    public class CollectionAddMethodIdentifier
    {

        /// <summary>
        /// Returns all of the Methods that are used to add items to inner collections
        /// </summary>
        ...
        public MethodTemplate GetMethod(PropertyTemplate tCollectionProp)
        {
            ...
            var linkerMethodName = string.Concat("AddTo", tCollectionProp.Name);
