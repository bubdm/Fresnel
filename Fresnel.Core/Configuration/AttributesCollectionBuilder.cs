...
namespace Envivo.Fresnel.Core.Configuration
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public class AttributesCollectionBuilder
    {
        public AttributesCollection BuildFor(Type classType)
        {
        ...
        /// <remarks></remarks>
        public AttributesCollection BuildFor(Type classType, IClassConfiguration outerClassConfig)
        {
            var result = new AttributesCollection();

            var isCustomConfigurationAvailable = false;
            if (outerClassConfig != null)
            {
                var attribute = outerClassConfig.ObjectInstanceConfiguration;
                if (attribute != null)
                {
        ...
        /// <remarks></remarks>e
        public AttributesCollection BuildFor(PropertyInfo propertyInfo, IClassConfiguration outerClassConfig)
        {
            var result = new AttributesCollection();
        ...
        /// <remarks></remarks>
        public AttributesCollection BuildFor(MethodInfo methodInfo, IClassConfiguration outerClassConfig)
        {
            var result = new AttributesCollection();
        ...
        /// <remarks></remarks>
        public AttributesCollection BuildFor(ParameterInfo parameterInfo, IClassConfiguration outerClassConfig)
        {
            var result = new AttributesCollection();
        ...
        private void LoadAttributesFrom(object[] attributes, AttributesCollection attributesCollection)
        {
            if (attributes == null)
                return;
            ...
            foreach (var item in attributes)
            {
                ...
                if (attributesCollection.Contains(key))
                    continue;

                attributesCollection.Add(key, (BaseAttribute)item);
            }
        }
