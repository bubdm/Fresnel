...
namespace Envivo.TrueView.Utils
{
    ...
    /// runtime version.
    /// </summary>
    public class NetFxVersionChecker
    {

        // Constants representing registry key names and value names
        private readonly string Netfx10RegKeyName = "Software\\Microsoft\\.NETFramework\\Policy\\v1.0";
        private readonly string Netfx10RegKeyValue = "3705";
        private readonly string Netfx10SPxMSIRegKeyName = "Software\\Microsoft\\Active Setup\\Installed Components\\{78705f0d-e8db-4b2d-8193-982bdda15ecd}";
        private readonly string Netfx10SPxOCMRegKeyName = "Software\\Microsoft\\Active Setup\\Installed Components\\{FDC11A6F-17D1-48f9-9EA3-9051954BAA24}";
        private readonly string Netfx11RegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v1.1.4322";
        private readonly string Netfx20RegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v2.0.50727";
        private const string Netfx30RegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v3.0\\Setup";
        private readonly string Netfx30SpRegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v3.0";
        private readonly string Netfx30RegValueName = "InstallSuccess";
        private readonly string Netfx35RegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v3.5";
        private readonly string Netfx4ClientRegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v4\\Client";
        private readonly string Netfx4FullRegKeyName = "Software\\Microsoft\\NET Framework Setup\\NDP\\v4\\Full";
        
        private readonly string NetfxStandardRegValueName = "Install";
        private readonly string NetfxStandrdSpxRegValueName = "SP";
        private readonly string NetfxStandardVersionRegValueName = "Version";

        private readonly string Netfx20PlusBuildRegValueName = "Increment";
        private readonly string Netfx35PlusBuildRegValueName = "Build";

        private readonly string Netfx30PlusWCFRegKeyName = Netfx30RegKeyName + "\\Windows Communication Foundation";
        private readonly string Netfx30PlusWPFRegKeyName = Netfx30RegKeyName + "\\Windows Presentation Foundation";
        private readonly string Netfx30PlusWFRegKeyName = Netfx30RegKeyName + "\\Windows Workflow Foundation";
        private readonly string Netfx30PlusWFPlusVersionRegValueName = "FileVersion";
        private readonly string CardSpaceServicesRegKeyName = "System\\CurrentControlSet\\Services\\idsvc";
        private readonly string CardSpaceServicesPlusImagePathRegName = "ImagePath";

        private readonly string NetfxInstallRootRegKeyName = "Software\\Microsoft\\.NETFramework";
        private readonly string NetFxInstallRootRegValueName = "InstallRoot";

        private readonly Version Netfx10Version = new Version(1, 0, 3705, 0);
        private readonly Version Netfx11Version = new Version(1, 1, 4322, 573);
        private readonly Version Netfx20Version = new Version(2, 0, 50727, 42);
        private readonly Version Netfx30Version = new Version(3, 0, 4506, 26);
        private readonly Version Netfx35Version = new Version(3, 5, 21022, 8);
        private readonly Version Netfx4Version = new Version(4, 0, 30319, 1);

        private readonly string Netfx10VersionString = "v1.0.3705";
        private readonly string Netfx11VersionString = "v1.1.4322";
        private readonly string Netfx20VersionString = "v2.0.50727";
        private readonly string NetfxMscorwks = "mscorwks.dll";
        ...
        /// </remarks>
        private bool CheckFxVersion(FrameworkVersion frameworkVersion)
        {
            bool valid = false;
        ...
        /// Framework.
        /// </returns>
        private string GetMscorwksPath(FrameworkVersion frameworkVersion)
        {
            ...
            switch (frameworkVersion)
            {
                ...
                case FrameworkVersion.Fx30:
                case FrameworkVersion.Fx35:
                case FrameworkVersion.Fx4Client:
                case FrameworkVersion.Fx4Full:
        ...
        /// <returns>An <see cref="Int32"/> representing the service pack 
        /// level for the .NET Framework.</returns>
        private int GetNetfxSPLevel(string key, string value)
        {
            int regValue = 0;
        ...
        private Version GetNetfx10ExactVersion()
        {
            bool foundKey = false;
        ...
        private Version GetNetfx11ExactVersion()
        {
            int regValue = 0;
        ...
        private Version GetNetfx20ExactVersion()
        {
        ...
        private Version GetNetfxExactVersion(string key, string value)
        {
            string regValue = String.Empty;
        ...
        private bool GetRegistryValue<T>(RegistryHive hive, string key, string value, RegistryValueKind kind, out T data)
        {
            bool success = false;
            data = default(T);
        ...
        /// </remarks>
        private bool IsNetfx10Installed()
        {
            bool found = false;
            string regValue = string.Empty;
        ...
        /// </remarks>
        private bool IsNetfx11Installed()
        {
            bool found = false;
            int regValue = 0;
        ...
        /// </remarks>
        private bool IsNetfx20Installed()
        {
            bool found = false;
            int regValue = 0;
        ...
        /// </remarks>
        private bool IsNetfx30Installed()
        {
            bool found = false;
            int regValue = 0;
        ...
        /// </remarks>
        private bool IsNetfx35Installed()
        {
            bool found = false;
            int regValue = 0;
        ...
        /// <summary>
        /// Detects if the .NET 4 Client Framework is installed.
        /// </summary>
        /// <returns></returns>
        private bool IsNetfx4ClientInstalled()
        {
            var isFound = false;
            var regValue = 0;

            if (GetRegistryValue(RegistryHive.LocalMachine, Netfx4ClientRegKeyName, NetfxStandardRegValueName, RegistryValueKind.DWord, out regValue))
            {
                if (regValue == 1)
                {
                    isFound = true;
        ...
        /// <summary>
        /// Detects if the .NET 4 Full Framework is installed.
        /// </summary>
        /// <returns></returns>
        private bool IsNetfx4FullInstalled()
        {
            var isFound = false;
            var regValue = 0;

            if (GetRegistryValue(RegistryHive.LocalMachine, Netfx4FullRegKeyName, NetfxStandardRegValueName, RegistryValueKind.DWord, out regValue))
            {
                if (regValue == 1)
                {
                    isFound = true;
        ...
        private bool IsTabletOrMediaCenter()
        {
            return ((GetSystemMetrics(SystemMetric.SM_TABLETPC) != 0) || (GetSystemMetrics(SystemMetric.SM_MEDIACENTER) != 0));
        }


        private bool IsNetfx30CardSpaceInstalled()
        {
            bool found = false;
            string regValue = String.Empty;
        ...
        private int GetNetfx30CardSpaceSPLevel()
        {
            int servicePackLevel = -1;
            return servicePackLevel;
        }
        ...
        private Version GetNetfx30CardSpaceExactVersion()
        {
            string regValue = String.Empty;
        ...
        private bool IsNetfx30WCFInstalled()
        {
            bool found = false;
            int regValue = 0;
        ...
        private int GetNetfx30WCFSPLevel()
        {
            //int regValue = 0;
        ...
        private Version GetNetfx30WCFExactVersion()
        {
            string regValue = String.Empty;
        ...
        private bool IsNetfx30WPFInstalled()
        {
            bool found = false;
            int regValue = 0;
        ...
        // become available, this method will need to be revised to correctly
        // determine the service pack level.
        private int GetNetfx30WPFSPLevel()
        {
            //int regValue = 0;
        ...
        private Version GetNetfx30WPFExactVersion()
        {
            string regValue = String.Empty;
        ...
        private bool IsNetfx30WFInstalled()
        {
            bool found = false;
            int regValue = 0;
        ...
        // become available, this method will need to be revised to correctly
        // determine the service pack level.
        private int GetNetfx30WFSPLevel()
        {
            //int regValue = 0;
        ...
        private Version GetNetfx30WFExactVersion()
        {
            string regValue = String.Empty;
        ...
        /// versions.
        /// </summary>
        public IEnumerable InstalledFrameworkVersions
        {
            get
            {
                ...
                if (IsInstalled(FrameworkVersion.Fx4Client))
                {
                    yield return GetExactVersion(FrameworkVersion.Fx4Client);
                }
                if (IsInstalled(FrameworkVersion.Fx4Full))
                {
                    yield return GetExactVersion(FrameworkVersion.Fx4Full);
                }
            }
        }
        ...
        public bool IsInstalled(FrameworkVersion frameworkVersion)
        {
            bool ret = false;
            ...
            switch (frameworkVersion)
            {
                ...
                case FrameworkVersion.Fx4Client:
                    ret = IsNetfx4ClientInstalled();
                    break;

                case FrameworkVersion.Fx4Full:
                    ret = IsNetfx4FullInstalled();
                    break;
        ...
        public bool IsInstalled(WindowsFoundationLibrary foundationLibrary)
        {
            bool ret = false;
        ...
        /// </returns>
        public int GetServicePackLevel(FrameworkVersion frameworkVersion)
        {
            int servicePackLevel = -1;
            ...
            switch (frameworkVersion)
            {
                ...
                case FrameworkVersion.Fx4Client:
                    servicePackLevel = GetNetfxSPLevel(Netfx4ClientRegKeyName, NetfxStandrdSpxRegValueName);
                    break;

                case FrameworkVersion.Fx4Full:
                    servicePackLevel = GetNetfxSPLevel(Netfx4FullRegKeyName, NetfxStandrdSpxRegValueName);
                    break;
        ...
        /// found, -1 is returned.
        /// </returns>
        public int GetServicePackLevel(WindowsFoundationLibrary foundationLibrary)
        {
            int servicePackLevel = -1;
        ...
        /// number.
        /// </returns>
        public Version GetExactVersion(FrameworkVersion frameworkVersion)
        {
            Version fxVersion = new Version();
            ...
            switch (frameworkVersion)
            {
                ...
                case FrameworkVersion.Fx4Client:
                    fxVersion = GetNetfxExactVersion(Netfx4ClientRegKeyName, NetfxStandardVersionRegValueName);
                    break;

                case FrameworkVersion.Fx4Full:
                    fxVersion = GetNetfxExactVersion(Netfx4FullRegKeyName, NetfxStandardVersionRegValueName);
                    break;
        ...
        /// </returns>
        public Version GetExactVersion(WindowsFoundationLibrary foundationLibrary)
        {
            Version fxVersion = new Version();
